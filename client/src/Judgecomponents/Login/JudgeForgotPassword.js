...
export default class ForgotPassword extends Component {
    ...
    sendEmail = event => {
        if(this.state.email!==""){
            ...
            axios.post('/api/login/judge/forgotpassword', data, config)
                .then(response => {
    ...
    render() {
        return (
            <div>
                ...
                <Row>
                        <Col>
                            <h3>Forgot Password(Judge)</h3>
                            <small>Your password will be sent to your email.</small>
                        </Col>
                    </Row>
                    <Row>
                        <Col md={6}>
                        ...
                        <Col>
                        Go back to <a href="/judge" className="fp"> Login </a>
                        </Col>
                        </Row>
                </Container>
            </div>
