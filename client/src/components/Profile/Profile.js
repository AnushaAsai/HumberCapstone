...
class Profile extends Component {
    ...
    componentDidMount() {
        let decodeddata = decode(localStorage.getItem('adminToken')); 
        this.setState({firstname:decodeddata.admin.firstname})
        this.setState({lastname:decodeddata.admin.lastname})
        this.setState({email:decodeddata.admin.email})
        this.props.onchangeLocation(this.state.firstname + " " + this.state.lastname);
        axios.get('/api/admin/'+decodeddata.admin.id)
            .then(res => {
